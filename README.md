...
Loading edges and edge weights (with Time Decay) ...
  Time Decay Config: max_year=2018, decay_rate=0.95
  Train Base Weights (Count): min=1, max=16, mean=1.11
...
Computing node traits (EXACT LCC) via Matrix ops...
    Computing exact triangles via sparse matrix mult (A @ A)...
    Computing exact triangles via sparse matrix mult (A @ A)...
  Traits ready.
...
Scoring config
  ...
  combine=mul_pow gamma=1.0 lam=1.0
  use_l3=True rescue_mode=anchor beta=1e-06 l3_weight_v=False
  anchor_q=0.9 gate_floor=0.0
  Model: if AA>0 -> AA (*  gate if enabled); if AA==0 -> L3 rescue

[auto_gate] Calibrating gate thresholds on VALID (train graph) ...
  Batch-computing AA scores ...
  Batch-computing AA scores ...
  [auto_gate] Using top-50 edges for AA>0 calibration
  [auto_gate] Calibrated AA>0 thresholds:
    ext_thresh_1=0.4734 (pos_q95 + margin)
    ext_thresh_2=0.7627 (q33 of problematic NEG)
    ext_thresh_3=0.8766 (q67 of problematic NEG)
    lcc_thresh_1=0.5584
    lcc_thresh_2=0.5631
  [auto_gate] AA>0 Validation:
    POS violations: 1/50 (Stage1)
                    0/50 (Stage2)
                    0/50 (Stage3)
    NEG coverage: 33/50 (Stage1)
                  11/50 (Stage2)
                  5/50 (Stage3)

  [auto_gate_l3] Calibrating L3 gate thresholds (AA==0 world) ...
    pos AA==0 L3>0 ext_ratio samples: 0
    neg AA==0 L3>0 ext_ratio samples: 0
  [auto_gate_l3] WARNING: Not enough L3 ext_ratio samples for calibration.

[auto_beta] Calibrating anchor_scale on VALID (train graph) ...
  Batch-computing AA scores ...
  Batch-computing AA scores ...
  [auto_anchor] L3 nonzero counts (AA==0 only): pos_nz=8916/21101  neg_nz=553/99940
  [auto_anchor] 2D grid search: 1 floors x 25 q-points = 25 total
  [auto_anchor] Overall top 5:
    #1 floor=0.000 q=0.72 scale=0.0115628 Hits@50=0.673557 kth=0.0526124 pos_rescued=1933 neg_intrusion=8 ← BEST
    #2 floor=0.000 q=0.60 scale=0.0205584 Hits@50=0.671976 kth=0.0747537 pos_rescued=2270 neg_intrusion=13
    #3 floor=0.000 q=0.70 scale=0.0128099 Hits@50=0.671760 kth=0.0582869 pos_rescued=1933 neg_intrusion=8
    #4 floor=0.000 q=0.74 scale=0.0104769 Hits@50=0.671743 kth=0.0520646 pos_rescued=1812 neg_intrusion=8
    #5 floor=0.000 q=0.50 scale=0.0305891 Hits@50=0.671277 kth=0.0898526 pos_rescued=2647 neg_intrusion=18
  [auto_anchor] Best per gate_floor:
    floor=0.000: q=0.72 Hits@50=0.673557 kth=0.0526124 kth_aa=0.037086 rescued=1933 intrusion=8 ← BEST

  [auto_anchor] OPTIMIZED: gate_floor=0.0000 anchor_q=0.7200 → anchor_scale=0.0115628
  [auto_anchor] valid Hits@50=0.673557  (optimized on valid)
  [auto_anchor] neg safety: Qneg(0.99)=5.7399 → score=0.0663691 (kth ratio=1.7896)

Evaluating split: valid
  pos_edge: (60084, 2), neg_edge_raw: (100000, 2), neg_mode=shared
  Batch-computing AA scores ...
  ...
  [pos top50] top50: AA>0 frac=1.000  AA==0 frac=0.000
             ...
             min_strict(all): mean=0.1142 std=0.1133 q=[0.026  0.0383 0.0459 0.0784 0.1109 0.2316 0.4412]
             max_open(all):   mean=0.8858 std=0.1133 q=[0.5588 0.7684 0.8891 0.9216 0.9541 0.9617 0.974 ]
  ...
  [neg top50] top50: AA>0 frac=0.820  AA==0 frac=0.180
             ...
             min_strict(AA>0): mean=0.3550 std=0.3101 q=[0.     0.0718 0.1218 0.2381 0.5273 1.     1.    ]
             max_open(AA>0):   mean=0.6450 std=0.3101 q=[0.     0.     0.4727 0.7619 0.8782 0.9282 1.    ]
 ...
 1.4572e+03]
    ...
    min_strict: mean=0.2877 std=0.2683 q=[0.     0.0523 0.0857 0.1795 0.4168 0.7    1.    ]
    max_open:   mean=0.7123 std=0.2683 q=[0.     0.3    0.5832 0.8205 0.9143 0.9477 1.    ]
    corr(rank): corr(AA,min_strict)=-0.030
               corr(gate,min_strict)=0.041
  [neg AA>0 (all shared)] n=59
    ...
    min_strict: mean=0.3896 std=0.3337 q=[0.     0.069  0.1196 0.3048 0.564  1.     1.    ]
    max_open:   mean=0.6104 std=0.3337 q=[0.     0.     0.436  0.6952 0.8804 0.931  1.    ]
    corr(rank): corr(AA,min_strict)=-0.006
               corr(gate,min_strict)=-0.131
  ...
  [pos AA>0] AA-quantile bins: (0.0, 0.5, 0.9, 0.99, 1.0) -> thresholds [2.618436e-02 2.978780e+00 2.260081e+01 1.018633e+02 1.457192e+03]
    bin0: [0.0261844, 2.97878) n=19491 | AA_mean=1.2816 gate_mean=0.691242 min_strict_mean=0.297321
    bin1: [2.97878, 22.6008) n=15593 | AA_mean=8.01465 gate_mean=0.874287 min_strict_mean=0.258613
    bin2: [22.6008, 101.863) n=3509 | AA_mean=45.9596 gate_mean=0.957823 min_strict_mean=0.35581
    bin3: [101.863, 1457.19] n=390 | AA_mean=149.685 gate_mean=0.988462 min_strict_mean=0.357413
  [neg AA>0 (shared)] AA-quantile bins: (0.0, 0.5, 0.9, 0.99, 1.0) -> thresholds [0.013933 0.220618 1.20323  5.398447 7.449624]
    bin0: [0.0139334, 0.220618) n=29 | AA_mean=0.118079 gate_mean=0.474138 min_strict_mean=0.401815
    bin1: [0.220618, 1.20323) n=24 | AA_mean=0.469844 gate_mean=0.645833 min_strict_mean=0.383491
    bin2: [1.20323, 5.39845) n=5 | AA_mean=2.86879 gate_mean=0.8 min_strict_mean=0.317653
    bin3: [5.39845, 7.44962] n=1 | AA_mean=7.44962 gate_mean=1 min_strict_mean=0.544615
  Hits@10 (shared): 0.5076  (kth_neg=0.595321, pos_eq_kth=0.000, neg_eq_kth=0.000)
           bucket: AA==0_pos Hits@10=0.0068  |  AA>0_pos Hits@10=0.7787
  Hits@50 (shared): 0.6736  (kth_neg=0.0526124, pos_eq_kth=0.000, neg_eq_kth=0.000)
           bucket: AA==0_pos Hits@50=0.0916  |  AA>0_pos Hits@50=0.9886
  Hits@100 (shared): 0.7158  (kth_neg=0.016804, pos_eq_kth=0.000, neg_eq_kth=0.000)
           bucket: AA==0_pos Hits@100=0.1914  |  AA>0_pos Hits@100=0.9997
  [pos stats] aa0=21101 aa_pos=38983 l3_edges=21101 l3_nonzero=8916 (twohop_u=9038) l3_gate_mean=1.000
  [neg stats] aa0=99941 aa_pos=59 l3_edges=99940 l3_nonzero=553 (twohop_u=76950) l3_gate_mean=1.000

Evaluating split: test
  pos_edge: (46329, 2), neg_edge_raw: (100000, 2), neg_mode=shared
  Batch-computing AA scores ...
  ...
  [pos top50] top50: AA>0 frac=1.000  AA==0 frac=0.000
             ...
             min_strict(all): mean=0.1952 std=0.1596 q=[0.0259 0.0465 0.0593 0.1169 0.3615 0.4293 0.4902]
             max_open(all):   mean=0.8048 std=0.1596 q=[0.5098 0.5707 0.6385 0.8831 0.9407 0.9535 0.9741]
  ...
  [neg top50] top50: AA>0 frac=0.880  AA==0 frac=0.120
             ...
             min_strict(AA>0): mean=0.3439 std=0.2896 q=[0.     0.0748 0.1138 0.2539 0.4313 0.7941 1.    ]
             max_open(AA>0):   mean=0.6561 std=0.2896 q=[0.     0.2059 0.5687 0.7461 0.8862 0.9252 1.    ]
 ...
 1.5048e+03]
    ...
    min_strict: mean=0.2304 std=0.2160 q=[0.     0.0497 0.079  0.1494 0.3111 0.5238 1.    ]
    max_open:   mean=0.7696 std=0.2160 q=[0.     0.4762 0.6889 0.8506 0.921  0.9503 1.    ]
    corr(rank): corr(AA,min_strict)=-0.064
               corr(gate,min_strict)=0.035
  [neg AA>0 (all shared)] n=62
    ...
    min_strict: mean=0.3729 std=0.3230 q=[0.     0.0713 0.115  0.276  0.4563 1.     1.    ]
    max_open:   mean=0.6271 std=0.3230 q=[0.     0.     0.5437 0.724  0.885  0.9287 1.    ]
    corr(rank): corr(AA,min_strict)=-0.016
               corr(gate,min_strict)=-0.177
  Conditional summaries by AA-quantile bins (AA>0 only):
  [pos AA>0] AA-quantile bins: (0.0, 0.5, 0.9, 0.99, 1.0) -> thresholds [2.809546e-02 3.121363e+00 1.986437e+01 1.000104e+02 1.504776e+03]
    bin0: [0.0280955, 3.12136) n=15196 | AA_mean=1.31628 gate_mean=0.65634 min_strict_mean=0.241976
    bin1: [3.12136, 19.8644) n=12157 | AA_mean=7.8752 gate_mean=0.817492 min_strict_mean=0.21839
    bin2: [19.8644, 100.01) n=2736 | AA_mean=39.7962 gate_mean=0.927997 min_strict_mean=0.216505
    bin3: [100.01, 1504.78] n=304 | AA_mean=174.915 gate_mean=0.981908 min_strict_mean=0.258877
  [neg AA>0 (shared)] AA-quantile bins: (0.0, 0.5, 0.9, 0.99, 1.0) -> thresholds [0.013933 0.243763 1.142944 5.608464 8.367974]
    bin0: [0.0139334, 0.243763) n=31 | AA_mean=0.128615 gate_mean=0.516129 min_strict_mean=0.409392
    bin1: [0.243763, 1.14294) n=24 | AA_mean=0.46688 gate_mean=0.604167 min_strict_mean=0.321982
    bin2: [1.14294, 5.60846) n=6 | AA_mean=2.55633 gate_mean=0.833333 min_strict_mean=0.387454
    bin3: [5.60846, 8.36797] n=1 | AA_mean=8.36797 gate_mean=1 min_strict_mean=0.378378
  Hits@10 (shared): 0.5131  (kth_neg=0.595321, pos_eq_kth=0.000, neg_eq_kth=0.000)
           bucket: AA==0_pos Hits@10=0.0097  |  AA>0_pos Hits@10=0.7770
  Hits@50 (shared): 0.6802  (kth_neg=0.0681364, pos_eq_kth=0.000, neg_eq_kth=0.000)
           bucket: AA==0_pos Hits@50=0.0962  |  AA>0_pos Hits@50=0.9865
  Hits@100 (shared): 0.7220  (kth_neg=0.0237127, pos_eq_kth=0.000, neg_eq_kth=0.000)
           bucket: AA==0_pos Hits@100=0.1931  |  AA>0_pos Hits@100=0.9993
  [pos stats] aa0=15936 aa_pos=30393 l3_edges=15936 l3_nonzero=7257 (twohop_u=7793) l3_gate_mean=1.000
  [neg stats] aa0=99938 aa_pos=62 l3_edges=99937 l3_nonzero=632 (twohop_u=76949) l3_gate_mean=1.000
